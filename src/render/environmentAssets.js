...
export const ENVIRONMENT_MAP_PRESETS = Object.freeze([
  ...
  Object.freeze({
    ...
    kind: 'packaged',
    source: 'built-in',
    fileName: 'abandoned_hall_01_1k.hdr',
    assetUrl: '/render-environments/polyhaven/abandoned_hall_01_1k.hdr',
  ...
  Object.freeze({
    ...
    kind: 'packaged',
    source: 'built-in',
    fileName: 'abandoned_waterworks_1k.hdr',
    assetUrl: '/render-environments/polyhaven/abandoned_waterworks_1k.hdr',
    mimeType: 'image/vnd.radiance',
    attribution: 'Poly Haven · CC0',
  }),
  Object.freeze({
    ...
    kind: 'packaged',
    source: 'built-in',
    fileName: 'empty_warehouse_01_1k.hdr',
    assetUrl: '/render-environments/polyhaven/empty_warehouse_01_1k.hdr',
    mimeType: 'image/vnd.radiance',
    attribution: 'Poly Haven · CC0',
  }),
  Object.freeze({
    ...
    kind: 'packaged',
    source: 'built-in',
    fileName: 'abandoned_workshop_1k.hdr',
    assetUrl: '/render-environments/polyhaven/abandoned_workshop_1k.hdr',
    mimeType: 'image/vnd.radiance',
    attribution: 'Poly Haven · CC0',
  }),
  Object.freeze({
    ...
    kind: 'packaged',
    source: 'built-in',
    fileName: 'peppermint_powerplant_1k.hdr',
    assetUrl: '/render-environments/polyhaven/peppermint_powerplant_1k.hdr',
    mimeType: 'image/vnd.radiance',
    attribution: 'Poly Haven · CC0',
  }),
]);
